# Generated by Powerlevel10k configuration wizard on 2020-01-28 at 09:15 CST.
...
() {
  ...
  #typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|tanzu|clusterctl'
  ...
  POWERLEVEL9K_KUBECONTEXT_DEFAULT_CONTENT_EXPANSION+='${P9K_KUBECONTEXT_CLOUD_CLUSTER:-${P9K_KUBECONTEXT_USER}@${P9K_KUBECONTEXT_CLUSTER}}'
  ...
  #typeset -g POWERLEVEL9K_AWS_SHOW_ON_COMMAND='aws2|aws|awless|terraform|pulumi'
